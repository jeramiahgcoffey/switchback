...
- **Garage** (`/garage`) — choose one of four rig profiles, tune its specs (tires, clearance, range, lockers, winch, …), see a readiness matrix against every trail, and build a gear loadout from a 70-item catalog with a live payload bar.
